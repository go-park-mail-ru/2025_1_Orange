-- Типы перечислений для вакансии
...
CREATE TABLE vacancy (
    ...
    working_hours INTEGER CHECK (working_hours > 0 AND working_hours <= 168), 
...
-- Связь вакансий и специализаций (если вакансия может иметь несколько специализаций)
...
-- Функция для обновления updated_at при изменениях
...
-- Триггер на обновление вакансий
