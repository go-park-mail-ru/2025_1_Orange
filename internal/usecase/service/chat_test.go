...
// func TestChatService_GetVacancyChat(t *testing.T) {
// 	t.Parallel()
// 	now := time.Now()
...
// 		applicantID    int
// 		role           string
// 		mockSetup      func(chatRepo *mock.MockChatRepository, chatUC *m.MockChat)
// 		expectedResult *dto.ChatResponse
// 		expectedErr    error
// 	}{
// 		{
// 			name:        "Success - existing chat",
// 			vacancyID:   1,
// 			applicantID: 10,
// 			role:        "applicant",
// 			mockSetup: func(chatRepo *mock.MockChatRepository, chatUC *m.MockChat) {
// 				chatRepo.EXPECT().
// 					GetForVacancy(gomock.Any(), 1, 10).
// 					Return(&entity.Chat{
// 						ID:          100,
// 						VacancyID:   1,
// 						ResumeID:    5,
...
// 				chatUC.EXPECT().
// 					GetChat(gomock.Any(), 100, 10, "applicant").
// 					Return(&dto.ChatResponse{
// 						ID:        100,
// 						Vacancy:   &dto.VacancyChatResponse{ID: 1, EmployerID: 20, Title: "Backend Developer"},
// 						Resume:    &dto.ResumeChatResponse{ID: 5, ApplicantID: 10, Profession: "Senior Go Developer"},
// 						CreatedAt: now,
// 						UpdatedAt: now,
// 					}, nil)
// 			},
...
// 		},
// 		{
// 			name:        "Success - new chat created",
// 			vacancyID:   2,
// 			applicantID: 11,
// 			role:        "applicant",
// 			mockSetup: func(chatRepo *mock.MockChatRepository, chatUC *m.MockChat) {
// 				chatRepo.EXPECT().
// 					GetForVacancy(gomock.Any(), 2, 11).
// 					Return(nil, nil)

// 				chatRepo.EXPECT().
// 					GetVacancyChatInfo(gomock.Any(), 2, 11).
// 					Return(&entity.VacancyChatInfo{
// 						VacancyID:  2,
// 						ResumeID:   6,
// 						EmployerID: 21,
// 					}, nil)
...
// 				chatUC.EXPECT().
// 					StartChat(gomock.Any(), 2, 6, 11, 21).
// 					Return(101, nil)

// 				chatUC.EXPECT().
// 					GetChat(gomock.Any(), 101, 11, "applicant").
// 					Return(&dto.ChatResponse{
// 						ID:        101,
// 						Vacancy:   &dto.VacancyChatResponse{ID: 2, EmployerID: 21, Title: "Frontend Developer"},
// 						Resume:    &dto.ResumeChatResponse{ID: 6, ApplicantID: 11, Profession: "React Specialist"},
// 						CreatedAt: now,
// 						UpdatedAt: now,
// 					}, nil)
// 			},
...
// 		},
// 		{
// 			name:        "Error - GetForVacancy fails",
// 			vacancyID:   3,
// 			applicantID: 12,
// 			role:        "applicant",
// 			mockSetup: func(chatRepo *mock.MockChatRepository, _ *m.MockChat) {
// 				chatRepo.EXPECT().
// 					GetForVacancy(gomock.Any(), 3, 12).
// 					Return(nil, errors.New("database error"))
// 			},
// 			expectedErr: errors.New("database error"),
// 		},
// 		{
// 			name:        "Error - GetVacancyChatInfo fails",
// 			vacancyID:   4,
// 			applicantID: 13,
// 			role:        "applicant",
// 			mockSetup: func(chatRepo *mock.MockChatRepository, _ *m.MockChat) {
// 				chatRepo.EXPECT().
// 					GetForVacancy(gomock.Any(), 4, 13).
// 					Return(nil, nil)

// 				chatRepo.EXPECT().
// 					GetVacancyChatInfo(gomock.Any(), 4, 13).
// 					Return(nil, errors.New("database error"))
// 			},
// 			expectedErr: errors.New("database error"),
// 		},
// 		{
// 			name:        "Error - no vacancy chat info found",
// 			vacancyID:   5,
// 			applicantID: 14,
// 			role:        "applicant",
// 			mockSetup: func(chatRepo *mock.MockChatRepository, _ *m.MockChat) {
// 				chatRepo.EXPECT().
// 					GetForVacancy(gomock.Any(), 5, 14).
// 					Return(nil, nil)

// 				chatRepo.EXPECT().
// 					GetVacancyChatInfo(gomock.Any(), 5, 14).
// 					Return(nil, nil)
// 			},
// 			expectedErr: entity.NewError(entity.ErrNotFound, errors.New("отклик не найден")),
// 		},
// 		{
// 			name:        "Error - StartChat fails",
// 			vacancyID:   6,
// 			applicantID: 15,
// 			role:        "applicant",
// 			mockSetup: func(chatRepo *mock.MockChatRepository, chatUC *m.MockChat) {
// 				chatRepo.EXPECT().
// 					GetForVacancy(gomock.Any(), 6, 15).
// 					Return(nil, nil)

// 				chatRepo.EXPECT().
// 					GetVacancyChatInfo(gomock.Any(), 6, 15).
// 					Return(&entity.VacancyChatInfo{
// 						VacancyID:  6,
// 						ResumeID:   7,
// 						EmployerID: 22,
...
// 				chatUC.EXPECT().
// 					StartChat(gomock.Any(), 6, 7, 15, 22).
// 					Return(0, errors.New("start chat error"))
// 			},
// 			expectedErr: errors.New("start chat error"),
// 		},
// 		{
// 			name:        "Error - GetChat fails after creating new chat",
// 			vacancyID:   7,
// 			applicantID: 16,
// 			role:        "applicant",
// 			mockSetup: func(chatRepo *mock.MockChatRepository, chatUC *m.MockChat) {
// 				chatRepo.EXPECT().
// 					GetForVacancy(gomock.Any(), 7, 16).
// 					Return(nil, nil)

// 				chatRepo.EXPECT().
// 					GetVacancyChatInfo(gomock.Any(), 7, 16).
// 					Return(&entity.VacancyChatInfo{
// 						VacancyID:  7,
// 						ResumeID:   8,
// 						EmployerID: 23,
...
// 				chatUC.EXPECT().
// 					StartChat(gomock.Any(), 7, 8, 16, 23).
// 					Return(102, nil)

// 				chatUC.EXPECT().
// 					GetChat(gomock.Any(), 102, 16, "applicant").
// 					Return(nil, errors.New("get chat error"))
// 			},
// 			expectedErr: errors.New("get chat error"),
// 		},
// 		{
// 			name:        "Error - GetChat fails for existing chat",
// 			vacancyID:   8,
// 			applicantID: 17,
// 			role:        "applicant",
// 			mockSetup: func(chatRepo *mock.MockChatRepository, chatUC *m.MockChat) {
// 				chatRepo.EXPECT().
// 					GetForVacancy(gomock.Any(), 8, 17).
// 					Return(&entity.Chat{
// 						ID:          103,
// 						VacancyID:   8,
// 						ResumeID:    9,
...
// 				chatUC.EXPECT().
// 					GetChat(gomock.Any(), 103, 17, "applicant").
// 					Return(nil, errors.New("get chat error"))
// 			},
// 			expectedErr: errors.New("get chat error"),
// 		},
...
// 			result, err := service.GetVacancyChat(ctx, tc.vacancyID, tc.applicantID, tc.role)
...
func TestChatService_GetChat(t *testing.T) {
	...
	testCases := []struct {
		...
		{
			name:   "Success - full chat response",
			chatID: 1,
			userID: 10,
			role:   "applicant",
			mockSetup: func(chatRepo *mock.MockChatRepository, vacancyUC *m.MockVacancy, resumeUC *m.MockResumeUsecase, applicantUC *m.MockApplicant, employerUC *m.MockEmployer) {
				...
				vacancyUC.EXPECT().
					GetVacancy(gomock.Any(), 100, 10, "applicant").
				...
				resumeUC.EXPECT().
					GetByID(gomock.Any(), 200).
					Return(&dto.ResumeResponse{
						ID:                        200,
						ApplicantID:               10,
						AboutMe:                   "Passionate software engineer with 8+ years experience in backend development.",
						...
						Skills:                    []string{"Go", "Docker", "Kubernetes", "Microservices"},
						AdditionalSpecializations: []string{"Distributed Systems", "Cloud Computing"},
						WorkExperiences: []dto.WorkExperienceResponse{
							{
								ID:           1,
								EmployerName: "TechCorp",
								Position:     "Go Developer",
								Duties:       "Разработка масштабируемых бэкенд-сервисов на Go.",
								Achievements: "Оптимизация производительности сервиса на 30%.",
				...
				applicantUC.EXPECT().
					...
					Return(&dto.ApplicantProfileResponse{
						AvatarPath: "/avatars/applicant.jpg",
					}, nil)

				employerUC.EXPECT().
					GetUser(gomock.Any(), 50).
					Return(&dto.EmployerProfileResponse{
						LogoPath: "/logos/employer.png",
					}, nil)
			},
			expectedResult: &dto.ChatResponse{
				ID: 1,
		...
		},
		{
			...
			mockSetup: func(chatRepo *mock.MockChatRepository, vacancyUC *m.MockVacancy, resumeUC *m.MockResumeUsecase, applicantUC *m.MockApplicant, employerUC *m.MockEmployer) {
				...
				vacancyUC.EXPECT().
					GetVacancy(gomock.Any(), 101, 30, "applicant").
					Return(nil, errors.New("vacancy not found"))
			},
			expectedResult: nil,
			expectedErr:    errors.New("vacancy not found"),
		},
		{
			name:   "Error - GetByID (resume) fails",
			chatID: 4,
			userID: 40,
			role:   "applicant",
			mockSetup: func(chatRepo *mock.MockChatRepository, vacancyUC *m.MockVacancy, resumeUC *m.MockResumeUsecase, applicantUC *m.MockApplicant, employerUC *m.MockEmployer) {
				...
				vacancyUC.EXPECT().
					GetVacancy(gomock.Any(), 102, 40, "applicant").
					Return(&dto.VacancyResponse{
						ID:         102,
						EmployerID: 51,
				...
				resumeUC.EXPECT().
					GetByID(gomock.Any(), 202).
					Return(nil, errors.New("resume not found"))
			},
			expectedResult: nil,
			expectedErr:    errors.New("resume not found"),
		},
		{
			...
			mockSetup: func(chatRepo *mock.MockChatRepository, vacancyUC *m.MockVacancy, resumeUC *m.MockResumeUsecase, applicantUC *m.MockApplicant, employerUC *m.MockEmployer) {
				...
				vacancyUC.EXPECT().
					GetVacancy(gomock.Any(), 103, 50, "applicant").
					Return(&dto.VacancyResponse{
						ID:         103,
						EmployerID: 52,
						Title:      "QA Engineer",
		...
		},
		{
			...
			mockSetup: func(chatRepo *mock.MockChatRepository, vacancyUC *m.MockVacancy, resumeUC *m.MockResumeUsecase, applicantUC *m.MockApplicant, employerUC *m.MockEmployer) {
				...
				vacancyUC.EXPECT().
					GetVacancy(gomock.Any(), 104, 60, "applicant").
					Return(&dto.VacancyResponse{
						ID:         104,
						EmployerID: 53,
				...
				applicantUC.EXPECT().
					GetUser(gomock.Any(), 52).
					Return(&dto.ApplicantProfileResponse{AvatarPath: "/avatars/app52.png"}, nil)

				employerUC.EXPECT().
					GetUser(gomock.Any(), 53).
...
func TestChatService_GetUserChats(t *testing.T) {
	...
	tests := []testCase{
		...
		// 		// no setup needed
		// 	},
		// 	expectedErr: entity.NewError(entity.ErrBadRequest, fmt.Errorf("неизвестная роль пользователя: %s", "unknown")),
		// },
		{
			name:   "repo error",
			userID: 1,
